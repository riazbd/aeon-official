<!-- Modal -->
<div class="modal fade" id="{{ 'edit-buyer-' . $buyer->id }}" tabindex="-1" role="dialog" aria-labelledby="edit-buyer"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="">Edit Buyer</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('update-buyer', ['id' => $buyer->id]) }}" method="POST" id="buyer-create-form"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" id="name" name="name"
                            placeholder="Enter Name" value="{{ $buyer->name }}">
                    </div>
                    {{-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <img src="{{ asset($buyer->logo) }}" alt="Buyer Logo" class="mt-3"
