            ...
            <div class="modal-body">
                <form action="{{ route('manufacturer-certificate-store') }}" method="POST" id="contact-create-form"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm" id="designation" name="issue_date"
                            placeholder="Enter Designation">
                    </div>
                    <div class="form-group">
                        <label for="designation">Valid To</label>
                        <input type="text" class="form-control form-control-sm" id="designation" name="valid_to"
                            placeholder="Enter Designation">
                    </div>
                    <div class="form-group">
