    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
        <div class="accordion-item">
            ...
            <div  id="flush-collapseOne" class="rowItem row accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="text" value="" name="block" id="block" placeholder="BLOCK" class="form-control" />
            ...
            <div id="flush-collapseOne" class="rowItem row accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                ...
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="text" value="" name="styleDescription" id="styleDescription" placeholder="Style Description" class="form-control" />
                        <label for="styleDescription">Style Description</label>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-floating">
                        <input type="text" value="" name="colour" id="colour" placeholder="Colour" class="form-control" />
